...
const {GetInfo, GetByAddress, CountMoney, GetSequence, UpdateName, UpdateAvatar, GetAvatar, GetName, GetEnergy,FollowUser,GetFollowing, GetFollower} = require('../controllers/Detail');
